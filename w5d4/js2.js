function titleize(array, printCallBack) {
  function printCallBack(current_name) {
    console.log("Mx. " + current_name + " Jingleheimer Schmidt");
  }
  for (let i = 0; i < array.length; i++) {
    printCallBack(array[i])
  }
}


function titleize(array, cb) {
  var titleized = array.map(function(current_name) {
    return "Mx. " + current_name + " Jingleheimer Schmidt"
  })
